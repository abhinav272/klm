...
public class OperationalFlight {
    ...
    @Expose
    private List<CodeShareRelation> codeShareRelations = null;
    ...
    public List<CodeShareRelation> getCodeShareRelations() {
        return codeShareRelations;
    }

    public void setCodeShareRelations(List<CodeShareRelation> codeShareRelations) {
        this.codeShareRelations = codeShareRelations;
    }
